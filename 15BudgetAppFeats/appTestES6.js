...
Hello! Thanks for taking the time to review my code :) I tried to keep everything as organized and easy to read as possible. Each completed challenge is well marked and (hopefully) easy to find. 
...
////////////// BUDGET CONTROLLER //////////////
// This function handles everything to do with the budget calculations and data

const budgetController = (function() {

//////////// SECTION 7 CHALLENGE -  CLASSES ////////////
////////////////////////////////////////////////////////

// ADD CLASSES START


    // Replaced constructor functions with classes
    ...
    // prototype method that will return the percentage
...
//////////// SECTION 7 CHALLENGE - ARROW FUNCTIONS ////////////
// replaced regular function here with arrow function syntax
...
//////////////////////// CHALLENGE #3 ALERT USER IF OVER BUDGET ////////////////////////
////////////////////////////////////////////////////////////////////////////////////////
...
// #3 STARTS HERE
            ...
            if (data.budget < 0) {
                ...
                alert('Carful! you are over budget!');
...
function formatNumber(num, type) {
    ...
    Here is an example of what is going on inside each function:
        ...
        funtion { 
            ...
            then returns result = typeStr + numSet1 + ',' + numSet2 + ',' + numSet3 + '.' + dec);
    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            if (type === 'inc') {
                ...
                //////////// SECTION 7 CHALLENGE - IMPLEMENT ES6 ////////////
                // Added template literal here in place of regular strings
...
// #4 STARTS HERE
        ...
        // original code: (input.description !== "" && !isNaN(input.value) && input.value > 0 )
