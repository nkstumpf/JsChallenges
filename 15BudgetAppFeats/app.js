...
var UIController = (function() {
    ...
    if the number = 25000.456789
    math.abs = 25000.00.456789
    math.toFixed(2) = 25000.45
    split('.') = "25000, 45"
    numsplit = "25000, 45"
    int = [0] = "25000"
    dec = [1] = "45"
    ...
    */
    ...
    // using the "absolute" method which changes the number back to a positive number
    num = Math.abs(num);
    
    // then the "toFixed" method which converts the number to a string and keeps only 2 decimals
    num = num.toFixed(2);
    ...
    // if the length of the integer is > 3
    if (int.length > 3) {

        // the substr method "extracts" parts of a string, beginning at the character at the specified position, and returns the specified number of characters
        int = int.substr(0, int.length - 3) + ',' + // take the strings length -3 and place a comma
