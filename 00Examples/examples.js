...
// Call allows you to call a specific function on a specific object without using a protoype
...
var myFunction = function(a, b) {
    this.randomNumber + a + b;
};

console.log('///////// CALL EXAMPLE /////////')
console.log(myFunction.call(myObject, 2, 2));
